...
import { Layers, CheckCircle2, Eye, EyeOff, Lock, User, Key, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex font-sans bg-[#0B0F19] relative">
      ...
      <div className="hidden lg:flex flex-col w-[55%] p-16 relative overflow-hidden justify-center border-r border-gray-800">
        ...
        <div className="absolute bottom-8 left-16 text-gray-600 text-xs font-medium">
          © 2026 GradeSync · For Filipino Educators
        </div>
      </div>
        ...
        <div className="max-w-md w-full">
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-400 tracking-wider">EMPLOYEE ID</label>
            ...
            <button 
              type="submit"
              className="w-full bg-amber-400 hover:bg-amber-500 text-[#0B0F19] font-bold text-base py-3.5 rounded-xl shadow-[0_0_20px_rgba(251,191,36,0.15)] hover:shadow-[0_0_25px_rgba(251,191,36,0.25)] transition-all flex items-center justify-center gap-2"
            >
        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-[#111827] border border-gray-800 rounded-3xl max-w-105 w-full p-8 relative overflow-hidden shadow-2xl">
            ...
            <form onSubmit={handlePasswordResetSubmit} className="space-y-6">
              ...
              <div className="space-y-2.5">
                {[
                  ...
                  <div key={req.id} className="flex items-center gap-2">
                    <CheckCircle2 
                      size={16} 
                      className={strength[req.id] ? "text-emerald-500" : "text-gray-600"} 
                    />
                    <span className={`text-xs ${strength[req.id] ? "text-gray-300" : "text-gray-500"}`}>
                      {req.text}
                    </span>
                  </div>
                ))}
              ...
              <button 
                type="submit"
                className="w-full bg-[#92733A] hover:bg-amber-500 text-[#0B0F19] font-bold text-base py-3.5 rounded-xl transition-colors mt-4"
              >
                Set New Password
              </button>
